...
function Verify(props) {
    ...
    async function verify() {
        ...
        try {
            let item = { code };
            let result = await fetch("https://backendssh.vercel.app/admin/verify", {
                method: "POST",
                headers: {
    ...
    async function resend() {
        ...
        try {
            let user = { username };
            let result = await fetch("https://backendssh.vercel.app/admin/resend", {
                method: "POST",
                headers: {
                    "Accept": "application/json",
                    "Content-type": "application/json",
        ...
        <div className='fle'>
            <div className="registration-form">
                <form> <div className="form-group">
                    <h5 className='bbnew'>Check Your E-mail</h5></div>
                    ...
                    <div >
                        ...
                        {errorMessage &&
                            <div className="invcode">{errorMessage}
                            </div>}
